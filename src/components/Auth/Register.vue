        ...
        <b-col sm="12" md="5" lg="5">
          <b-card>
            ...
            <span class="tx-14 wt-600 gray">
              You must have an active Zoom account to register for Candidate Rank and the email address below must match the email address associated with your Zoom account. You can create a Zoom account 
              <a target="_blank" href="https://zoom.com">here</a>
            </span>
            <br />
            <hr />
            <b-row>

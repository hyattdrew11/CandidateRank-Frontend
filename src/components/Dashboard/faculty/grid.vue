  ...
  <div id="admin-ranking-container" class="mt-3">
    <b-row>
        ...
        <b-card>
          <b-row>
            ...
            <b-col sm="8">
              ...
              <span class="float-right tx-12 wt-500 gray">{{ candidates.length }} Pre-Interview Candidates</span>
            </b-col>
          </b-row>
          <hr />
          <ag-grid-vue
     ...
     <div id="application-container" :class="{'d-none': !showApplication}">
       <PDFRender :candidate="candidate" @closeApplication="closeApplication()"></PDFRender>
      </div>
       ...
       <div id="pi-survey-container" v-if="showSurvey" :class="{'d-none': !showSurvey}">
          <b-row no-gutters>
            <b-col sm="12" class="mt-2 pt-2">
              ...
              <intSurvey :organization="organization" :user="user" :candidate="candidate" :survey="survey" @closeSurvey="closeSurvey" @updateCandidate="updateCandidatePIScore"></intSurvey>
            </b-col>
          </b-row>
        </div>

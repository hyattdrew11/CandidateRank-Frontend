<template>
  <div v-if="survey" class="pt-4">
    <i id="loader" v-if="loading" class="fa fa-spinner fa-pulse fa-3x fa-fw text-info" aria-hidden="true"></i>
    <div :class="{fade : loading }">
      <!-- <div v-html="wooForm"></div> -->
      <div v-if="!wooForms" v-html="wooForm"></div>
      <div v-if="wooForms">
        <b-tabs>
          <b-tab title="Application survey" active><div v-html="wooForms[0]" class="pt-4"></div></b-tab>
          <b-tab title="Interview Survey"><div v-html="wooForms[1]" class="pt-4"></div></b-tab>
        </b-tabs>
      </div>

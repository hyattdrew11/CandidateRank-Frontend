<template>
  <div id="admin-ranking-container" class="mt-3">
    <b-row>
       <b-col sm="8">
        <h4 v-if="currentTerm != null">{{ currentTerm.department }} Interview List {{ currentTerm.year }}</h4>
      ...
      <b-col sm="4">
        <p><label class="tx-12 wt-600 dark-gray">Scheduling Actions:</label></p>
        <b-button size="sm" class="ml-1">Add selected candidates to schedule</b-button>
      </b-col>
      <b-col sm="12">
        <hr />
        <b-card>

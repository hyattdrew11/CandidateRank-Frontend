<template>
  <div id="admin-ranking-container" class="mt-3">
    <b-row>
       <b-col sm="8">
        <h4 v-if="currentTerm != null">
          {{ currentTerm.department }} Pre-Interview List {{ currentTerm.year }}
          <br />
          <span class="tx-12 wt-500 gray">{{ candidates.length }} Candidates</span>
        </h4>
      ...
      <b-col sm="4">
        <p><label class="tx-12 wt-600 dark-gray">Notify Evaluators:</label></p>
        <b-button size="sm" class="ml-1">Send SMS</b-button>
        <b-button size="sm" class="ml-1">Send Email</b-button>
      </b-col>
      <b-col sm="12">
        <hr />
        <b-card>
...
import {fields} from '../../candidateFields'

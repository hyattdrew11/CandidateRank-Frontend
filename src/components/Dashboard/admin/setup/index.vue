  ...
  <div class="container-fluid">
    <b-row no-gutters>
       <b-tabs id="setup-tabs" class="" v-model="tabIndex" card>
        ...
        <b-tab ref="em" title="Evaluator(s) Management">
        ...
        <b-tab ref="ms" title="Master Schedule">
          <masterSchedule 
            :organization="organization" 
            :user="user" 
            :candidates="candidates" 
         ...
         <b-tab ref="sm" title="Survey Management">
          <surveyManagement 
            :organization="organization" 
            :user="user" 
            :candidates="candidates" 
        ...
        <b-tab ref="impD" title="Import / Filter Data">
          <importData 
            :organization="organization" 
            :user="user" 
            :candidates="candidates" 
         ...
         <b-tab ref="ms" title="Notifications">

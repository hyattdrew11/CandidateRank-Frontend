        ...
        <b-card id="surveyPreview" v-if="survey != null">
          <div>
            ...
            <b-col sm="4" class="">
              ...
              <b-col sm="4">
                ...
                <b-form-select v-model="survey.type" :options="surveyTypes"></b-form-select>
              </b-col>
          ...
          <hr />
              ...
              <draggable
                ...
                @end="dragging = false"
              >
                <div v-for="(x, index) in survey.questions" :key="index"  class="list-group-item">
      ...
      if(this.surveyType == null) { 
        ...
        window.axios.post(API_URL+'/survey/add', input)
          .then(({data}) => {
            ...
            alert(this.surveyType + ': '  + this.surveyName + " sucessfully saved and activated. Move on ot next step.")
            this.questions = []
